...
public class DateUtil {
    ...
    public static long getTwoTimeDiffSecond(LocalDateTime time1, LocalDateTime time2) {

        long diff =  Duration.between(time1,time2).toMillis();
        if (diff > 0) {
            return diff;
        } else {
            return 0;
